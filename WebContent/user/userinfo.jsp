...
//个人信息页面修改信息时也要对表单内容用js进行验证，套路与register.jsp里的js验证一样
//给修改按钮绑定鼠标单击事件
...
<body>
    ...
    <div class="container4">
    	<div class="register_box">
    			...
    			<div class="security">
    				<form action="user/UpdateUserSer" method="post"><!-- post与get区别可以去查一下，post安全性更高 -->
    					<ul class="list">
    						<li>
    								<input id="J_euserName" class="long" readonly="readonly" name="username" value="${sessionScope.user.username}" type="text" />
    								<div class="name">用户名:</div><!-- 用户名 不让修改只读，readonly="readonly"-->
